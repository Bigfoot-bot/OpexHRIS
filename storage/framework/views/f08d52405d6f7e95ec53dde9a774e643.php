...
<head>
    ...
    <title><?php echo e(tenant('name') ?? 'HRIS'); ?> - Login</title>
    ...
    <div class="w-full max-w-md">
        <div class="flex justify-center mb-8">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <div class="text-emerald-900 text-lg font-medium"><?php echo e(tenant('name') ?? 'HRIS Platform'); ?></div>
            ...
            <form method="POST" action="<?php echo e(route('tenant.login.post')); ?>">
                ...
                <div class="mb-5">
                    ...
                    <input type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus
                           class="w-full px-4 py-2.5 rounded-lg border border-gray-200 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent placeholder:text-gray-300"
                ...
                <div class="mb-2">
                    ...
                    <div style="position:relative;">
                        <input type="password" name="password" id="password" required
                               class="w-full px-4 py-2.5 pr-10 rounded-lg border border-gray-200 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent placeholder:text-gray-300"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="flex justify-end mb-6">
                    <a href="<?php echo e(route('tenant.password.request')); ?>" class="text-xs text-emerald-600 hover:text-emerald-800">Forgot password?</a>
                </div>
                <button type="submit"
        ...
        <p class="text-center text-xs text-gray-400 mt-6">
            <?php echo e(tenant('name') ?? 'HRIS Platform'); ?> &copy; <?php echo e(date('Y')); ?>
...
<?php /**PATH C:\Users\hezek\Herd\hris-platform\resources\views/tenant/auth/login.blade.php ENDPATH**/ ?>