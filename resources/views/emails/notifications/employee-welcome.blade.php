                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
                    ...
                    <tr>
                        <td style="background:#ffffff;border-radius:16px;border:1px solid #d1fae5;padding:40px;">
                            <h2 style="margin:0 0 8px;font-size:20px;color:#064e3b;text-align:center;">Welcome to {{ $tenantName }}</h2>
                            <p style="margin:0 0 24px;font-size:14px;color:#6b7280;text-align:center;">Hi {{ $user->name }}, your account has been created on the HRIS portal.</p>
                            ...
                            <p style="font-size:13px;color:#6b7280;text-align:center;margin:0 0 20px;">Use the button below to set your password and access your account.</p>
                            ...
                            <p style="font-size:12px;color:#9ca3af;text-align:center;margin:0;">If you did not expect this email, please ignore it.</p>
                        </td>
                    </tr>
                    <tr>
