                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
                    ...
                    <tr>
                        <td style="background:#ffffff;border-radius:16px;border:1px solid #d1fae5;padding:40px;">
                            ...
                            <h2 style="margin:0 0 8px;font-size:20px;color:#064e3b;text-align:center;">You're all set, {{ $user->name }}!</h2>
                            <p style="margin:0 0 24px;font-size:14px;color:#6b7280;text-align:center;">Your password has been successfully set. Your {{ $tenantName }} HRIS account is ready to use.</p>
                            ...
                            <p style="font-size:13px;color:#6b7280;text-align:center;margin:0 0 20px;">Click the button below to log in to your portal.</p>

                            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ $loginLink }}" style="display:inline-block;background-color:#065f46;color:#ffffff;text-decoration:none;font-size:14px;font-weight:600;padding:12px 32px;border-radius:8px;">
                                            Go to Portal
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <p style="font-size:12px;color:#9ca3af;text-align:center;margin:0 0 8px;">Log in with your email address and the password you just set.</p>
                            <hr style="border:none;border-top:1px solid #d1fae5;margin:20px 0;"/>
                            <p style="font-size:12px;color:#9ca3af;text-align:center;margin:0;">If you did not perform this action, please contact your HR administrator immediately.</p>
                        </td>
                    </tr>
                    <tr>
