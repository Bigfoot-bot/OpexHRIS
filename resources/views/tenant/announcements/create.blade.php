...
@section('page-subtitle', 'Send an announcement to all employees')
        ...
        <form method="POST" action="{{ route('tenant.announcements.store') }}">
            ...
            <div class="space-y-5">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <label for="send_email" class="text-sm text-gray-600">Send email notification to all employees</label>
                </div>
            </div>
